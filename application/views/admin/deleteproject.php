...
<hr>
 ...
 <form action="<?php echo base_url('admin/home/delete_project_by_id') ?>" method="POST">
              <div class="row">
                <div class="large-6 columns">
                    <label><h4>Delete by Id<h4></label>
                    <input id="addproject_name" type="text" placeholder="Enter id" name="id" style="width:90px;">
                </div>
                <div class="large-6 columns">
...
<td><a href="<?php echo $news_item['link'] ?>" target=_blank> <?php echo $news_item['link'] ?>  </a></td>
